...
| **Methods — How We Did It (Heartbeat & Recoil)** | CAPSULE_METHODS_HEARTBEAT | *(tbd)* | *(tbd)* | *(tbd)* |
...
[HEARTBEAT_DASHBOARD.md](dashboard/HEARTBEAT_DASHBOARD.md) — live plots, capsules, physicist note, and public story mirrored for visitors.
...
- Physicist Note PDF, Public Story capsule, Heartbeat Dashboard, and Methods capsule are surfaced for both rigorous and outreach audiences.  
- The  ledger preserves the chronology of discovery as a **front‑door map for auditors and the public**.

---

**Ledger proud — Master Index updated with direct navigation to the Heartbeat Dashboard and Methods capsule.**
