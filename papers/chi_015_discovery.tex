...
A custom Python engine (`imperial_logger.py`) processes the raw telemetry stream. For every data point, it calculates the instantaneous $\chi$ value against a 24-hour rolling baseline.
